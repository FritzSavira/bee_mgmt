...
def new_harvest(hive_id):
    if request.method == 'POST':
        ...
        return redirect(url_for('harvests_controller.harvests_list', hive_id=hive_id))
    return render_template('new_harvest.html', hive_id=hive_id)
...
def edit_harvest(hive_id, harvest_id):
    ...
    if request.method == 'POST':
        ...
        return redirect(url_for('harvests_controller.harvests_list', hive_id=hive_id))
    return render_template('edit_harvest.html', hive_id=hive_id, harvest=harvest)
