...
def new_treatment(hive_id):
    if request.method == 'POST':
        ...
        return redirect(url_for('treatments_controller.treatments_list', hive_id=hive_id))
    return render_template('new_treatment.html', hive_id=hive_id)
...
def edit_treatment(hive_id, treatment_id):
    ...
    if request.method == 'POST':
        ...
        return redirect(url_for('treatments_controller.treatments_list', hive_id=hive_id))
    return render_template('edit_treatment.html', hive_id=hive_id, treatment=treatment)
