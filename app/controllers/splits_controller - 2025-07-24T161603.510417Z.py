...
def new_split(hive_id):
    if request.method == 'POST':
        ...
        return redirect(url_for('splits_controller.splits_list', hive_id=hive_id))
    return render_template('new_split.html', hive_id=hive_id)
...
def edit_split(hive_id, split_id):
    ...
    if request.method == 'POST':
        ...
        return redirect(url_for('splits_controller.splits_list', hive_id=hive_id))
    return render_template('edit_split.html', hive_id=hive_id, split=split)
